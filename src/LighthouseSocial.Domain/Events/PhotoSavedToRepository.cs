...
public class PhotoSavedToRepository(Guid photoId, string fileName, Guid userId, Guid lighthouseId, string cameraType, string resolution, string lens, DateTime savedAt)
        : EventBase(photoId)
{
